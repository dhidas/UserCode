...
int main(int argc, char **argv){
 ...
 // -- command line arguments
  ...
  for (unsigned int sampleCounter = 0; sampleCounter < s.size(); sampleCounter++){
    ...
    sprintf(rangeFileName,"/home/l_tester/sensorTest/output/singleROC_%s/range_%s.txt",
    ...
    //analyze noise if indicated
      ...
      sprintf(noiseRootFileName, "/home/l_tester/sensorTest/output/singleROC_%s/Noise_scurve.root", s.at(sampleCounter).name);
  ...
  for (int sampleCounter=0; sampleCounter< s.size(); sampleCounter++){
    ...
    if (s.at(sampleCounter).structure == "dot1")
    {
      markerType = 20;
      if(dot1counter2 == 0)
      {
    ...
    else if (s.at(sampleCounter).structure == "gap30")
    {
      markerType = 21;
      if(gap30counter2 == 0)
      {
    ...
    else if (s.at(sampleCounter).structure == "gap30-2")
    {
      markerType = 22;
