...
def plotMttbar():
    ...
    # data =  TFile.Open("Run_5000pb_PFElectron_PF2PATJets_PFMET.root");
    ttbar =  TFile.Open("TTJets_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # ttbar =  TFile.Open("TT_Tune_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # wjets =  TFile.Open("WJetsToLNu_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # wjets =  TFile.Open("WToENu_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # zjets =  TFile.Open("DYJetsToLL_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # bce1 =  TFile.Open("QCD_Pt-20to30_BCtoE_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # bce2 =  TFile.Open("QCD_Pt-30to80_BCtoE_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # bce3 =  TFile.Open("QCD_Pt-80to170_BCtoE_5000pb_PFElectron_PF2PATJets_PFMET.root");
    ...
    # Zprime500 = TFile.Open("Zprime_M500GeV_W50GeV_5000pb_PFElectron_PF2PATJets_PFMET.root");
    # Zprime1500 = TFile.Open("Zprime_M1500GeV_W15GeV_5000pb_PFElectron_PF2PATJets_PFMET.root");
    ...
    # Zprime4000 = TFile.Open("Zprime_M4000GeV_W400GeV_5000pb_PFElectron_PF2PATJets_PFMET.root");
    ...
    # WprimeToTTBbar_M1000 = TFile.Open("WprimeToTBbar_M-1000_5000pb_PFElectron_PF2PATJets_PFMET.root");
...
#    Zprime1500 = TFile.Open("/storage/workspace/BristolAnalysisTools/outputfiles/Zprime_M1500GeV_W15GeV_36.135pb.root");
    ...
    hists.append("mass_vs_transMass");
    hists.append("good_vs_badwp1topmass");
#    
...
#                hist_qcd.Scale(nqcd/hist_qcd.Integral())
        ...
        # hist_data = hist_wpm800.Clone("test");
        # hist_data = hist_wpm1000.Clone("test");
       # hist_data = hist_ttbar.Clone("test");
        rebin = 1;
        Urange = (0,5000)
        if ("mass_vs_transMass" in histname):
            hist_data.SetXTitle("mass(lepton+1bjet)/GeV");
            hist_data.SetYTitle("transMass(lepton+MET+1bjet)/GeV");
            rebin = 4;
            Urange = (0, 2000)
        elif ("good_vs_badwp1topmass" in histname):
            hist_data.SetXTitle("W' mass good reco/GeV");
            hist_data.SetYTitle("W' mass bad reco/GeV");
            rebin = 4;
            Urange = (0, 2000)
        ...
        hist_ttbar.Rebin2D(rebin, rebin);
        hist_wpm1000.Rebin2D(rebin, rebin);
        hist_wpm600.Rebin2D(rebin, rebin);
        hist_wpm800.Rebin2D(rebin, rebin);
        if ('jet1' in histname):
                  hist_data.Rebin2D();
                  # hist_ttbar.Rebin2D();
        ...
        hist_ttbar.SetMarkerStyle(2);
        hist_ttbar.SetMarkerSize(2);
...
#
        ...
        hist_wpm1000.SetMarkerColor(kOrange + 1);
        hist_wpm600.SetMarkerColor(kGray + 3);
        hist_wpm800.SetMarkerColor(kBlack);
        hist_wpm1000.SetMarkerStyle(2);
        hist_wpm600.SetMarkerStyle(2);
        hist_wpm800.SetMarkerStyle(1);
        hist_wpm600.SetMarkerSize(2);
        hist_wpm800.SetMarkerSize(1);
        hist_wpm1000.SetMarkerSize(2);
...
#        qcdUncert.SetFillStyle(3003);
        ...
        leg = TLegend(0.696, 0.15, 0.95, 0.72);
        leg.SetBorderSize(1);
        leg.SetLineStyle(0);
        leg.SetTextFont(42);
        leg.SetFillStyle(0);
        ...
        # leg.AddEntry(hist_ttbar, "t#bar{t}", "P");
...
#        leg.AddEntry(hist_Zprime1250, "Z' 1.25TeV");
        leg.AddEntry(hist_wpm600, "W't .6TeV (8 pb)", "P");
        leg.AddEntry(hist_wpm800, "W't .8TeV (2.2 pb)", "P");
        leg.AddEntry(hist_wpm1000, "W't 1TeV (0.72 pb)", "P");
        # leg.AddEntry(hist_wptb1000, "W'-> tb 1TeV (8 pb)", "L");

        
				# Need to loop through samples to be plotted  *****

        canvases.append(TCanvas("cname" + histname, histname, 1200, 900))
        canvases[-1].cd().SetRightMargin(0.1);
        if ('jet1' in histname):
          hist_data.SetMarkerStyle(8);
        ...
        # hist_data.Draw("box");
        hist_data.Draw("axis");
        # NOTE:  "scat" doesn't work with the histograms from W'600.
        # This script slows way down and the plots are missing most points.
        # "box" produces the plots OK.  Only W'600 shows this problem.
        # Its 2D histograms are inherently messed up.
...
#        hist_Zprime1250.Draw("same");
        ...
        # hist_wpm600.Draw("colz same");
        # hist_wpm800.Draw("same");
        # hist_wpm1000.Draw("same");
        hist_ttbar.Draw("colz same");
...
def plusminuscmp():
    WprimeTToTTD_M600 = TFile.Open("WprimeTToTTD_M600_5000pb_PFElectron_PF2PATJets_PFMET.root");
    hist_wpm600pl =  WprimeTToTTD_M600.Get("wpmassplus_1orMoreBtag");
    hist_wpm600mi =  WprimeTToTTD_M600.Get("wpmassminus_1orMoreBtag");
    rebin = 60;
    Urange = (0, 2000)
    hist_wpm600pl.SetXTitle("Reco W' mass/GeV");
    hist_wpm600pl.SetYTitle("Events/(60 GeV)");
    hist_wpm600pl.Rebin(rebin);
    hist_wpm600pl.SetAxisRange(Urange[0], Urange[1]);
    hist_wpm600mi.Rebin(rebin);
    hist_wpm600mi.SetAxisRange(Urange[0], Urange[1]);
    hist_wpm600pl.SetLineColor(kGray + 3);
    hist_wpm600mi.SetLineColor(kCyan);
    linewidth = 6;
    hist_wpm600pl.SetLineWidth(linewidth);
    hist_wpm600mi.SetLineWidth(linewidth);
    leg = TLegend(0.696, 0.35, 0.95, 0.92);
    leg.SetBorderSize(0);
    leg.SetLineStyle(0);
    leg.SetTextFont(42);
    leg.SetFillStyle(0);
    leg.AddEntry(hist_wpm600pl, "W't+ .6TeV (8 pb)", "L");
    leg.AddEntry(hist_wpm600mi, "W't- .6TeV (8 pb)", "L");
    hist_wpm600pl.SetStats(1);
    hist_wpm600pl.Draw();
    hist_wpm600mi.Draw("same");
    leg.Draw();
    canvases[-1].SaveAs('plots/' + 'wpmassplusminus' + '.png')
